...
const outputPath = isDebug
    ? config.dev.dll.basePath
    : config.build.dll.basePath;
             ...
             */
            {
                ...
                use: [
                    ...
                    },
                    {
                        ...
                        options: {
                            //这里暂时只能用query，不能用options，否则会报错：Module build failed: ModuleBuildError: Module build failed: Error: No PostCSS Config found in: h5app\src
                            config: {
