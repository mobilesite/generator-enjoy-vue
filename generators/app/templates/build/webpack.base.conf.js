...
var entries = Object.assign({}, config.pageEntries, config.commonLibDependencies);
...
(function(){
  ...
  types.map(function (type) {
    ...
    fs.writeFile(utils.joinPath(config.alias[`${type.name}s`], 'main.js'), entryFileContent.join(lineEnd), function (err) {
      if (err) throw err;
